(()=>{'use strict';
// V29 bootloader: lógica estable + cambio privado de jugador + tablero estrictamente privado + entrada pública.
...
load(base,()=>load('./turn_gate_v25.js?v=25b',()=>load('./privacy_v26.js?v=29',()=>load('./public_entry_v27.js?v=27'))));
})();
